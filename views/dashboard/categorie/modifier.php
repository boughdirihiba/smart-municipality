...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image_url = $old['image_url']; // Garder l'ancienne par défaut
    ...
    if (empty($errors)) {
        ...
        $categorieObj = new CategorieEvenement();
        $categorieObj->setNom($old['nom']);
        $categorieObj->setDescription($old['description']);
        $categorieObj->setImageUrl($image_url);
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <div class="form-body">
                ...
                <?php if ($old['image_url'] && file_exists('../../../' . $old['image_url'])): ?>
                <div class="current-image">
                    <i class="fas fa-image" style="color: #1a5e2a; font-size: 1.2rem;"></i>
                    <span>Image actuelle :</span>
                    <img src="../../../<?php echo $old['image_url']; ?>" alt="Image actuelle">

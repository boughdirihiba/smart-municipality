...
<head>
    <meta charset="UTF-8">
    <title>Ajouter un service - Smart Municipality</title>
        ...
        <div class="main-content">
            <div class="header">
                <div>
                    ...
                    <p>Créez un service pour les citoyens</p>
                </div>
            ...
            <div class="form-container">
                <h2><i class="fas fa-plus-circle"></i> Formulaire d'ajout</h2>
                
                <form action="index.php?action=store_service" method="POST">
                    <div class="form-group">
                        <label><i class="fas fa-tag"></i> Nom du service</label>
                        <input type="text" name="nom" placeholder="Ex: Légalisation de documents" required>
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-align-left"></i> Description</label>
                        <textarea name="description" rows="4" placeholder="Description détaillée du service..." required></textarea>
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-icons"></i> Icône Font Awesome</label>
                        <select name="icone">
                            <option value="fas fa-gavel">🔨 Gavel (Légalisation)</option>
                            <option value="fas fa-baby-carriage">👶 Baby Carriage (Naissance)</option>
                            <option value="fas fa-coins">💰 Coins (Taxes)</option>
                            <option value="fas fa-folder-open">📁 Folder (Dossier)</option>
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-save"></i> Ajouter le service
                    </button>
                </form>

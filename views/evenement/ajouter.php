<?php
// Variables provided by legacy_router: $categories, $ev_errors, $ev_old, $categorie_preselect
$ev_errors = $ev_errors ?? [];
$ev_old    = $ev_old    ?? [];
$categorie_preselect = $categorie_preselect ?? 0;
?>
...
<div class="form-container">
    ...
    <div class="form-body">
        ...
        <form method="POST" action="<?php echo BASE_URL; ?>/index.php?action=ajouter_evenement<?php echo $categorie_preselect ? '&categorie=' . $categorie_preselect : ''; ?>">
            <div class="mb-3">
            ...
            <div class="ev-row mb-3">
                <div>
                    ...
                    <input type="date" name="date_evenement" class="ev-input <?php echo isset($ev_errors['date_evenement']) ? 'is-invalid' : ''; ?>"
                           value="<?php echo htmlspecialchars($ev_old['date_evenement'] ?? ''); ?>" min="<?php echo date('Y-m-d'); ?>">
            ...
            <div class="mb-4">
                ...
                <select name="categorie_id" class="ev-select <?php echo isset($ev_errors['categorie_id']) ? 'is-invalid' : ''; ?>">
                    ...
                    <option value="<?php echo $cat['id']; ?>" <?php echo (($ev_old['categorie_id'] ?? $categorie_preselect) == $cat['id']) ? 'selected' : ''; ?>>

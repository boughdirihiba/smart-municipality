            ...
            <nav class="nav-menu">
                <ul>
                    <li>
                        ...
                        <a href="<?php echo BASE_URL; ?>/index.php?action=profil">Profile</a>
                    </li>
                    <li>
                        <img src="<?php echo BASE_URL; ?>/assets/icons/alertes.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/index.php?action=evenements">Événements</a>
                    </li>
                    <li>
                        <img src="<?php echo BASE_URL; ?>/assets/icons/carte.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/index.php?route=home/index">Carte intelligente</a>
                    </li>
                    <li>
                        <img src="<?php echo BASE_URL; ?>/assets/icons/blog.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/index.php?action=blog">Blog</a>
                    </li>
                    <li>
                        <img src="<?php echo BASE_URL; ?>/assets/icons/services.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/index.php?action=list_services">Services en ligne</a>
                    </li>
                    <li class="active">
                        <img src="<?php echo BASE_URL; ?>/assets/icons/rdv.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/index.php?action=rdv_backoffice">Rendez-vous</a>
                    </li>
                </ul>
                <ul class="sub-nav">
                    <li class="sub-active"><a href="<?php echo BASE_URL; ?>/index.php?action=rdv_backoffice">&rsaquo; Liste RDV</a></li>
                    <li><a href="<?php echo BASE_URL; ?>/index.php?action=rdv_categories">&rsaquo; Catégories</a></li>
                </ul>
            </nav>
            ...
            <div class="nav-bottom">
                <ul>
                    <li>
                        ...
                        <a href="<?php echo BASE_URL; ?>/index.php?route=home/index">Paramètres</a>
                    </li>
                    <li>
                        <img src="<?php echo BASE_URL; ?>/assets/icons/deconnexion.svg" alt="">
                        <a href="<?php echo BASE_URL; ?>/logout.php">Déconnexion</a>
                    </li>
                </ul>
            </div>
        ...
        <main class="main-content">
            ...
            <header class="top-bar">
                <div class="top-bar-left">
                    ...
                    <a href="<?php echo BASE_URL; ?>/index.php?action=rdv_categories" class="btn-manage-cat">
            ...
            <form method="GET" action="<?php echo BASE_URL; ?>/index.php" class="filters">
                <input type="hidden" name="action" value="rdv_backoffice">
                <select name="service">
                ...
                <a href="<?php echo BASE_URL; ?>/index.php?action=rdv_backoffice">Réinitialiser</a>
            </form>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo BASE_URL; ?>/index.php?action=rdv_confirm&id=" + id;
                    });
                }
            });
        }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo BASE_URL; ?>/index.php?action=rdv_cancel&id=" + id;
                    });
                }
            });
        }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo BASE_URL; ?>/index.php?action=rdv_delete&id=" + id + "&from=back";
                    });
                }
            });
        }

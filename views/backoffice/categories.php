...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'upload_icon' && isset($_FILES['icon_file'])) {
    ...
    $redirect = 'categories.php' . ($q ? '?' . implode('&', $q) : '');
            ...
            <div class="workspace">
                ...
                <section class="gallery-panel">
                    <div class="gallery-header">
                        <div class="gallery-title-wrap">
                            ...
                            <a href="categories.php?new=1<?php echo !empty($search) ? '&search='.urlencode($search) : ''; ?>" class="new-cat-btn">
                    ...
                    <div class="gallery-grid-wrap">
                        <div class="gallery-grid">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                <a href="categories.php?edit=<?php echo $cat['id']; ?><?php echo !empty($search) ? '&search='.urlencode($search) : ''; ?>" class="cat-card <?php echo $isSel ? 'selected' : ''; ?>">
                ...
                <section class="editor-panel">
                    ...
                    <form class="editor-scroll" id="categoryForm"
                          action="/smart-municipality/controllers/RendezVousController.php"
                          method="POST">
                        <input type="hidden" name="action" value="<?php echo $isCreating ? 'create_category' : 'update_category'; ?>">
                        <?php if (!$isCreating): ?>
                        ...
                        <div class="preview-card-wrap">
                            <div class="preview-card">
                                <div class="preview-icon-wrap">
                                    <img id="previewIcon" src="../../assets/icons/<?php echo htmlspecialchars($selectedCat['icone'] ?? 'rdv.svg'); ?>" alt="">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="icon-picker-current" onclick="toggleIconPicker()">
                                <img class="icon-picker-current-img" id="iconPickerImg"
                                     src="../../assets/icons/<?php echo htmlspecialchars($selectedCat['icone'] ?? 'rdv.svg'); ?>" alt="">

<div class="card">
	...
	<form method="post" action="<?php echo BASE_URL; ?>/index.php?route=admin/edit" novalidate>
		...
		<label for="progression" style="margin-top: 0.9rem;">Progression du signalement (%)</label>
		<input
			id="progression"
			name="progression"
			type="range"
			...
			max="100"
			step="1"
			value="<?php echo e((string)($item['progression'] ?? '0')); ?>"
			oninput="document.getElementById('progressionValue').textContent = this.value + '%'"
		>
		<div class="progress-input-meta">
			<span id="progressionValue"><?php echo e((string)($item['progression'] ?? '0')); ?>%</span>
		</div>

...
<head>
    ...
    <title>Smart Municipality - Ajouter un événement</title>
        ...
        <form method="POST" action="" enctype="multipart/form-data" id="eventForm">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" name="date_evenement" class="form-control" id="dateEvent" required>
            ...
            <div class="form-group">
                ...
                <small>Formats acceptés : JPG, PNG, GIF (max 10 Mo)</small>
            </div>

<?php
// Modern event create view - form for creating a new event
$categories = $categories ?? [];
$pageTitle = $pageTitle ?? 'Créer un événement';
?>
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form method="POST" class="card p-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo BASE_URL; ?>/index.php?route=event/index" class="btn btn-secondary">
                        Annuler
                    </a>
                </div>
            </form>
